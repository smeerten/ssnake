...
class MainProgram(QtGui.QMainWindow):
    ...
    def initMenu(self):
        ...
        self.saveAct = self.savemenu.addAction(QtGui.QIcon(IconDirectory + 'JSON.png'),'Save JSON', self.saveJSONFile,QtGui.QKeySequence.Save)
        self.savemenu.addAction(QtGui.QIcon(IconDirectory + 'Matlab.png'),'Save MATLAB', self.saveMatlabFile)
	...
	#the fitting drop down menu
        ...
        self.fittingMenu.addAction("Spinning side&band", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.createHerzfeldBergerWindow()))
