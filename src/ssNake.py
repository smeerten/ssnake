...
class MainProgram(QtGui.QMainWindow):
    ...
    def initMenu(self):
        ...
        self.macrostartAct = self.macromenu.addAction('St&art recording', self.macroCreate)
        self.macrostopAct = self.macromenu.addAction('St&op recording', self.stopMacro)
	...
	#the tool drop down menu
        ...
        self.toolMenu.addAction(QtGui.QIcon(os.path.dirname(os.path.realpath(__file__))+os.path.sep+'Icons'+os.path.sep+'real.png'),"&Real", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.real()))
        ...
        self.matrixMenu.addAction(QtGui.QIcon(os.path.dirname(os.path.realpath(__file__))+os.path.sep+'Icons'+os.path.sep+'int.png'),"&Integrate", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.createIntegrateWindow()))
        self.matrixMenu.addAction(QtGui.QIcon(os.path.dirname(os.path.realpath(__file__))+os.path.sep+'Icons'+os.path.sep+'sum.png'),"S&um", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.createSumWindow()))
	...
	#the plot drop down menu
        ...
        self.plotMenu.addAction(QtGui.QIcon(os.path.dirname(os.path.realpath(__file__))+os.path.sep+'Icons'+os.path.sep+'1dplot.png'),"&1D plot", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.plot1D()))
        self.plotMenu.addAction(QtGui.QIcon(os.path.dirname(os.path.realpath(__file__))+os.path.sep+'Icons'+os.path.sep+'scatterplot.png'),"&Scatter plot", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.plotScatter()))
