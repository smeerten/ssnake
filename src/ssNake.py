...
class MainProgram(QtGui.QMainWindow):
	...
	#the tool drop down menu
        ...
        self.toolMenu.addAction(QtGui.QIcon('Icons'+os.path.sep+'real.png'),"&Real", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.real()))
        self.toolMenu.addAction(QtGui.QIcon('Icons'+os.path.sep+'imag.png'),"&Imag", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.imag()))
        self.toolMenu.addAction(QtGui.QIcon('Icons'+os.path.sep+'abs.png'),"&Abs", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.abs())) 
        ...
        self.matrixMenu.addAction(QtGui.QIcon('Icons'+os.path.sep+'int.png'),"&Integrate", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.createIntegrateWindow()))
        self.matrixMenu.addAction(QtGui.QIcon('Icons'+os.path.sep+'sum.png'),"S&um", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.createSumWindow()))
	...
	#the plot drop down menu
        ...
        self.plotMenu.addAction(QtGui.QIcon('Icons'+os.path.sep+'1dplot.png'),"&1D plot", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.plot1D()))
        self.plotMenu.addAction(QtGui.QIcon('Icons'+os.path.sep+'scatterplot.png'),"&Scatter plot", lambda: self.mainWindowCheck(lambda mainWindow: mainWindow.plotScatter()))
