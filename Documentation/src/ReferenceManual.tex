...
smoothly to 0 at the end of the time signal. Therefore $f(t) = \cos^2(t/t_\text{max} \cdot \pi/2)$ and the
...
\begin{equation}
  f(t) = \cos^2(n \cdot t/t_\text{max} \cdot \pi/2) \quad .
\end{equation}
This distribution is usually used for its easy use and certain decay to 0.
